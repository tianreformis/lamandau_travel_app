  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<OrderRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrderRecord> activeOrderPageOrderRecordList = snapshot.data;
        // Customize what your widget looks like with no query results.
        if (snapshot.data.isEmpty) {
          // return Container();
          // For now, we'll just include some dummy data.
          activeOrderPageOrderRecordList = createDummyOrderRecord(count: 1);
        }
        final activeOrderPageOrderRecord = activeOrderPageOrderRecordList.first;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.data.isEmpty) {
                      ...
                      listViewOrderRecordList =
                          createDummyOrderRecord(count: 4);
                    }
